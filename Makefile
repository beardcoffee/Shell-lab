...
TEAM = bjbeard
# replace NOBODY with either your UNO login name, or in the case of a group,
# replace NOBODY with you and your partner's login names. Example: TEAM = matoups2-hmahdi
VERSION = 1
HANDINDIR = /home/CSCI2467/handin/$(USER)/
DRIVER = ./sdriver.pl
TSH = ./tsh
TSHREF = ./tshref
TSHARGS = "-p"
